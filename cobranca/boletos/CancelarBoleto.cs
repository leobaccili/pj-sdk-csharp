...
namespace Sdk.CobrancaApi {
	public class CancelarBoleto {
		public void Cancelar(Config config, string nossoNumero, string motivoCancelamento) {
			InterSdk.LogInfo("EmitiCancelarBoletorBoleto {0} {1} {2}", config.ClientId, nossoNumero, motivoCancelamento);
			string url = Constants.URL_COBRANCA_BOLETOS.Replace("AMBIENTE", config.Ambiente) + "/" + nossoNumero + "/cancelar";
