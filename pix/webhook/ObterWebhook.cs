...
namespace Sdk.PixApi {
	public class ObterWebhook {
		public Webhook Obter(Config config, string chave) {
			...
			string url = Constants.URL_PIX_WEBHOOK_PIX.Replace("AMBIENTE", config.Ambiente) + "/" + chave;
			string json = HttpUtils.CallGet(config, url, Constants.ESCOPO_WEBHOOK_READ, "Erro ao obter webhook");
